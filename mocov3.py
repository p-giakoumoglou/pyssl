...
class MoCoV3(nn.Module):
    """ Contrastive-based Self-Supervised Learning: MoCo v3"""
    def __init__(self, backbone, feature_size, projection_dim=256, temperature=0.5, m=0.999,
        ...
        self.predictor = Predictor(in_dim=projection_dim, hidden_dim=2048, out_dim=projection_dim)
